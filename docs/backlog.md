...
- ✓ 2026-07-23 **C5. NEON PROTOCOL 本命主題第一版**(§4):首角 **Vesper**,機能軍事／霓虹特勤世界觀,Low Top-Down。18 組不重複透明 GIF 已依動作語意命名、歸檔至 `ui-asset-library/custom/sprites/vesper/animations/`,並建立 idle／move／hover／grab／action 可用主題。Workbench 外殼配色已與角色素材主題解耦；新增可獨立切換的科技白＋霓虹藍粉配色，原深藍＋黃字保留為 `NEXUS ARCADE`。
