...
- ✓ 2026-07-22 **C4. FallingSprites 夾娃娃機元件**(正本 `docs/falling-sprites-spec.md`):Matter.js 剛體 + activeTheme 四語意槽；箱頂纜線連接三爪夾具；60–160% 調整直接縮放既有 body、不重啟 Engine。容量依倍率為 30／24／18／14／10，既有角色不因放大自動刪除。每主題 roster 可新增、單隻移除、清空、技能卡拖入；角色落地後在多深度 2D 地面隨機直走／斜走，抓取仍切 grab；左側 PRIZE OUT 在抓取後投入會移除角色。
