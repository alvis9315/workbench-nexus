...
- **MVC2 Spider-Man 斷點續抓**:仍只執行 Spider-Man，動畫索引 316 組中已下載 76，去除 14 個完全重複後有 62 個 selector-ready；其餘 240 組繼續依 robots crawl-delay 斷點下載。後續順序固定為 Venom → Psylocke → Wolverine-A → Captain America → Iron Man → 其餘 Marvel → Capcom。
