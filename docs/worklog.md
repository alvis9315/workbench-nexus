...
- **MVC2 Spider-Man 斷點續抓**:仍只執行 Spider-Man，動畫索引 316 組中已下載 176，去除 26 個完全重複後有 150 個 selector-ready；其餘 140 組繼續依 robots crawl-delay 斷點下載。後續順序固定為 Venom → Psylocke → Wolverine-A → Captain America → Iron Man → 其餘 Marvel → Capcom。
