...
- **MVC2 Spider-Man 資料蒐集**:仍只執行 Spider-Man，actor animation GIF 已完成 316/316，去除 39 個完全重複別名後有 277 個 selector-ready、0 個待下載；hitbox GIF 已完成 317/317，後續繼續抓逐 keyframe sprite／effect 媒體。無可靠證據的招式對應維持 `needs_game_verification`。角色順序固定為 Venom → Psylocke → Wolverine-A → Captain America → Iron Man → 其餘 Marvel → Capcom。
