...
- **MVC2 Spider-Man 資料蒐集**:仍只執行 Spider-Man，actor animation GIF 已完成 316/316，去除 39 個完全重複別名後有 277 個 selector-ready、0 個待下載；hitbox GIF 已完成 317/317；逐 keyframe sprite PNG 已完成 82/907，collision hitbox/hurtbox PNG 已完成 3/1117，暫時網路失敗保留重試而不判定缺檔。無可靠證據的招式對應維持 `needs_game_verification`。角色順序固定為 Venom → Psylocke → Wolverine-A → Captain America → Iron Man → 其餘 Marvel → Capcom。
